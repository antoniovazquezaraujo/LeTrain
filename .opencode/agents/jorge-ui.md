...
- Sigue los principios de consistencia y legibilidad (WCAG cuando aplique).
- Asegura el desacoplamiento entre el renderizado (Vista) y el motor (Modelo) a través del Presentador.
