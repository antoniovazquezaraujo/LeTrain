...
*   **Class Index:** A complete list of project classes is maintained at `docs/developer/architecture/ClassIndex.md`. Consult this file to locate specific components. It is generated by `tools/gen-class-index.sh` and CI fails if it is out of date, so keep it trustworthy.
