...
public class Model implements letrain.mvp.Model {
    ...
    public List<GameModeMenuOption> getMenuModel() {
        return Arrays.asList(
                ...
                new GameModeMenuOption("si&gnals", "[Left/Right]:Select [m]:Max/Min [Up/Down]:Limit", () -> !getSpeedSignals().isEmpty(), () -> this.getMode() == GameMode.SPEED_SIGNALS, () -> GameMode.SPEED_SIGNALS),
