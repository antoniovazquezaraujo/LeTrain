...
public abstract class BaseSubRenderer implements Visitor {
    ...
    @Override
    public void visitEconomyManager(letrain.economy.EconomyManager economyManager) {}

    @Override
    public void visitModel(Model model) {}

    @Override
    public void visitRailMap(letrain.map.impl.RailMap map) {}

    @Override
    public void visitRailTrack(letrain.track.rail.RailTrack track) {}
    ...
    @Override
    public void visitSensor(letrain.track.Sensor sensor) {}

    @Override
    public void visitSemaphore(letrain.track.RailSemaphore semaphore) {}

    @Override
    public void visitStation(letrain.track.Station station) {}

    @Override
    public void visitGroundMap(letrain.ground.GroundMap groundMap) {}
