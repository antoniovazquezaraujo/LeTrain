...
public class GrammarReference {
    ...
    public static String getGuideString() {
        return "LeTrain Automation Reference:\n\n" +
                ...
                "  sensor ID on train enter|exit|enter forward|exit backward { actions }\n" +
                "  station ID on train enter|exit|enter forward|exit backward { actions }\n" +
                "  fork ID on train enter|exit { actions }\n" +
                "  semaphore ID on train enter|exit { actions }\n" +
                "  train ID on enter|exit|link|unlink { actions }\n" +
                "  train ID on crash|contact [forward|backward] { actions }\n\n" +
                "── Actions ──\n" +
                ...
                "  train 1 set speed 3;\n" +
                "  ---\n" +
                "  station 1 on train enter { train load; train unlink backward 1; }\n" +
