 ...
 * Verifies that transient fields are properly reinitialized after deserialization,
...
class SerializationTest {
    ...
    void testTrainListenerCallbacksPostDeserialization() throws IOException, ClassNotFoundException {
        ...
        // The listener list should be reinitialized to empty (transient fields not serialized)
    ...
    void testTransientFieldsNotSerialized() throws IOException, ClassNotFoundException {
        ...
        // Transient fields should not be in serialized data, but readObject() should reinitialize them
        Train restored = deserialize(serialized);
        assertNotNull(restored);
