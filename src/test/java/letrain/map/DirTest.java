...
class DirTest {
    ...
    @CsvSource({"W, E", "SW, NE", "S, N", "SE, NW", "E, W", "NE, SW", "N, S", "NW, SE"})
    ...
    @ParameterizedTest
    @CsvSource({"E, 0", "NE, 1", "N, 2", "NW, 3", "W, 4", "SW, -3", "S, -2", "SE, -1"})
    ...
    @ParameterizedTest
    @CsvSource({"SE, E", "E, NE", "NE, N", "N, NW", "NW, W", "W, SW", "SW, S", "S, SE"})
    void testTurnLeft(Dir a, Dir b) {
        Assertions.assertEquals(b, a.turnLeft());
    }

    @ParameterizedTest
    @CsvSource({"E, SE", "NE, E", "N, NE", "NW, N", "W, NW", "SW, W", "S, SW", "SE, S"})
