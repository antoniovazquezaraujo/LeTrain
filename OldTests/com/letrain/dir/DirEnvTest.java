...
public class DirEnvTest {
	...
	public void testGetFirstOpenOut() {
		...
		assertTrue(env.getFirstOpenDir() == Dir.N);
		env.addPath(Dir.E, Dir.W);
		assertTrue(env.getFirstOpenDir() == Dir.E);
	...
	public void testGetNumOpenOuts() {
		assertTrue(env.getNumOpenDirs() == 0);
		env.addPath(Dir.S, Dir.N);
		assertTrue(env.getNumOpenDirs() == 2);
		env.addPath(Dir.SW, Dir.NE);
		assertTrue(env.getNumOpenDirs() == 4);
