...
public record WaypointImpl(
        Waypoint.Type type, int targetId, Optional<Dir> entryDir, List<WaypointCommand> commands)
        implements Waypoint {
    ...
    public WaypointImpl(
            Waypoint.Type type, int targetId, Dir entryDir, List<WaypointCommand> commands) {
