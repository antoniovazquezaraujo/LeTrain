...
/**
 * Represents an element that can be attached to a track, such as a Semaphore, Sensor, or Station. A
 * track can only hold a single component at a time to prevent overlapping.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "@type")
@JsonSubTypes({@JsonSubTypes.Type(value = letrain.track.Sensor.class, name = "Sensor"),
